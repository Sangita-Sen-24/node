...
* \[[`082369159b`](https://github.com/nodejs/node/commit/082369159b)] - **doc**: stabilize util.styleText (Rafael Gonzaga) [#56265](https://github.com/nodejs/node/pull/56265)
* \[[`a9818860bb`](https://github.com/nodejs/node/commit/a9818860bb)] - **(SEMVER-MINOR)** **module**: add prefix-only modules to `module.builtinModules` (Jordan Harband) [#56185](https://github.com/nodejs/node/pull/56185)
...
* \[[`50ec6f9894`](https://github.com/nodejs/node/commit/50ec6f9894)] - **(SEMVER-MINOR)** **report**: fix typos in report keys and bump the version (Yuan-Ming Hsu) [#56068](https://github.com/nodejs/node/pull/56068)
* \[[`8981dedc3e`](https://github.com/nodejs/node/commit/8981dedc3e)] - **(SEMVER-MINOR)** **sqlite**: aggregate constants in a single property (Edigleysson Silva (Edy)) [#56213](https://github.com/nodejs/node/pull/56213)
* \[[`f86ca82684`](https://github.com/nodejs/node/commit/f86ca82684)] - **(SEMVER-MINOR)** **src,lib**: stabilize permission model (Rafael Gonzaga) [#56201](https://github.com/nodejs/node/pull/56201)
* \[[`64a5fed86f`](https://github.com/nodejs/node/commit/64a5fed86f)] - **(SEMVER-MINOR)** **stream**: handle generator destruction from Duplex.from() (Matthieu Sieben) [#55096](https://github.com/nodejs/node/pull/55096)
...
* \[[`dcfd250fab`](https://github.com/nodejs/node/commit/dcfd250fab)] - **buffer**: document concat zero-fill (Duncan) [#55562](https://github.com/nodejs/node/pull/55562)
* \[[`d62814dec0`](https://github.com/nodejs/node/commit/d62814dec0)] - **build**: set DESTCPU correctly for 'make binary' on loongarch64 (吴小白) [#56271](https://github.com/nodejs/node/pull/56271)
* \[[`46194cf785`](https://github.com/nodejs/node/commit/46194cf785)] - **build**: fix missing fp16 dependency in d8 builds (Joyee Cheung) [#56266](https://github.com/nodejs/node/pull/56266)
* \[[`cda0481bf6`](https://github.com/nodejs/node/commit/cda0481bf6)] - **build**: add major release action (Rafael Gonzaga) [#56199](https://github.com/nodejs/node/pull/56199)
* \[[`273712fd32`](https://github.com/nodejs/node/commit/273712fd32)] - **build**: fix C string encoding for `PRODUCT_DIR_ABS` (Anna Henningsen) [#56111](https://github.com/nodejs/node/pull/56111)
...
* \[[`c2fb38cfdf`](https://github.com/nodejs/node/commit/c2fb38cfdf)] - **crypto**: graduate WebCryptoAPI Ed25519 and X25519 algorithms as stable (Filip Skokan) [#56142](https://github.com/nodejs/node/pull/56142)
* \[[`c665f31d21`](https://github.com/nodejs/node/commit/c665f31d21)] - **deps**: update nghttp3 to 1.6.0 (Node.js GitHub Bot) [#56258](https://github.com/nodejs/node/pull/56258)
* \[[`3783b9bbde`](https://github.com/nodejs/node/commit/3783b9bbde)] - **deps**: update simdutf to 5.6.4 (Node.js GitHub Bot) [#56255](https://github.com/nodejs/node/pull/56255)
* \[[`91cdc42879`](https://github.com/nodejs/node/commit/91cdc42879)] - **deps**: update libuv to 1.49.2 (Luigi Pinca) [#56224](https://github.com/nodejs/node/pull/56224)
* \[[`f352406f83`](https://github.com/nodejs/node/commit/f352406f83)] - **deps**: update c-ares to v1.34.4 (Node.js GitHub Bot) [#56256](https://github.com/nodejs/node/pull/56256)
* \[[`05626bad3d`](https://github.com/nodejs/node/commit/05626bad3d)] - **deps**: define V8\_PRESERVE\_MOST as no-op on Windows (Stefan Stojanovic) [#56238](https://github.com/nodejs/node/pull/56238)
...
* \[[`1a593eea74`](https://github.com/nodejs/node/commit/1a593eea74)] - **dgram**: support blocklist in udp (theanarkh) [#56087](https://github.com/nodejs/node/pull/56087)
* \[[`53bc0c5806`](https://github.com/nodejs/node/commit/53bc0c5806)] - **doc**: fix color contrast issue in light mode (Rich Trott) [#56272](https://github.com/nodejs/node/pull/56272)
* \[[`082369159b`](https://github.com/nodejs/node/commit/082369159b)] - **doc**: stabilize util.styleText (Rafael Gonzaga) [#56265](https://github.com/nodejs/node/pull/56265)
* \[[`e80cce0b12`](https://github.com/nodejs/node/commit/e80cce0b12)] - **doc**: clarify util.aborted resource usage (Kunal Kumar) [#55780](https://github.com/nodejs/node/pull/55780)
* \[[`972c048d89`](https://github.com/nodejs/node/commit/972c048d89)] - **doc**: add esm examples to node:repl (Alfredo González) [#55432](https://github.com/nodejs/node/pull/55432)
* \[[`21cc803480`](https://github.com/nodejs/node/commit/21cc803480)] - **doc**: add esm examples to node:readline (Alfredo González) [#55335](https://github.com/nodejs/node/pull/55335)
* \[[`0d0e449c38`](https://github.com/nodejs/node/commit/0d0e449c38)] - **doc**: fix 'which' to 'that' and add commas (Selveter Senitro) [#56216](https://github.com/nodejs/node/pull/56216)
* \[[`e148baea98`](https://github.com/nodejs/node/commit/e148baea98)] - **doc**: fix winget config path (Alex Yang) [#56233](https://github.com/nodejs/node/pull/56233)
* \[[`419722ca70`](https://github.com/nodejs/node/commit/419722ca70)] - **doc**: add esm examples to node:tls (Alfredo González) [#56229](https://github.com/nodejs/node/pull/56229)
* \[[`06cf077722`](https://github.com/nodejs/node/commit/06cf077722)] - **doc**: add esm examples to node:perf\_hooks (Alfredo González) [#55257](https://github.com/nodejs/node/pull/55257)
* \[[`53fa38fbde`](https://github.com/nodejs/node/commit/53fa38fbde)] - **doc**: `sea.getRawAsset(key)` always returns an ArrayBuffer (沈鸿飞) [#56206](https://github.com/nodejs/node/pull/56206)
...
* \[[`c21a9e0b46`](https://github.com/nodejs/node/commit/c21a9e0b46)] - **fs**: make mutating `options` in Callback `readdir()` not affect results (LiviaMedeiros) [#56057](https://github.com/nodejs/node/pull/56057)
* \[[`2df8257c25`](https://github.com/nodejs/node/commit/2df8257c25)] - **fs**: make mutating `options` in Promises `readdir()` not affect results (LiviaMedeiros) [#56057](https://github.com/nodejs/node/pull/56057)
...
* \[[`e8294ad063`](https://github.com/nodejs/node/commit/e8294ad063)] - **http**: add setDefaultHeaders option to http.request (Tim Perry) [#56112](https://github.com/nodejs/node/pull/56112)
* \[[`92d5a03d9e`](https://github.com/nodejs/node/commit/92d5a03d9e)] - **http2**: remove duplicate codeblock (Vitaly Aminev) [#55915](https://github.com/nodejs/node/pull/55915)
...
* \[[`8e780bc5ae`](https://github.com/nodejs/node/commit/8e780bc5ae)] - **(SEMVER-MINOR)** **module**: use synchronous hooks for preparsing in import(cjs) (Joyee Cheung) [#55698](https://github.com/nodejs/node/pull/55698)
* \[[`e5bb6c2303`](https://github.com/nodejs/node/commit/e5bb6c2303)] - **(SEMVER-MINOR)** **module**: implement module.registerHooks() (Joyee Cheung) [#55698](https://github.com/nodejs/node/pull/55698)
* \[[`e7267679f6`](https://github.com/nodejs/node/commit/e7267679f6)] - **node-api**: allow napi\_delete\_reference in finalizers (Chengzhong Wu) [#55620](https://github.com/nodejs/node/pull/55620)
* \[[`50ec6f9894`](https://github.com/nodejs/node/commit/50ec6f9894)] - **(SEMVER-MINOR)** **report**: fix typos in report keys and bump the version (Yuan-Ming Hsu) [#56068](https://github.com/nodejs/node/pull/56068)
...
* \[[`8981dedc3e`](https://github.com/nodejs/node/commit/8981dedc3e)] - **(SEMVER-MINOR)** **sqlite**: aggregate constants in a single property (Edigleysson Silva (Edy)) [#56213](https://github.com/nodejs/node/pull/56213)
* \[[`9d50d9c879`](https://github.com/nodejs/node/commit/9d50d9c879)] - **sqlite**: add support for custom functions (Colin Ihrig) [#55985](https://github.com/nodejs/node/pull/55985)
...
* \[[`62b2f79170`](https://github.com/nodejs/node/commit/62b2f79170)] - **test**: remove test-sqlite-statement-sync flaky designation (Luigi Pinca) [#56051](https://github.com/nodejs/node/pull/56051)
* \[[`df3e2df622`](https://github.com/nodejs/node/commit/df3e2df622)] - **test**: use --permission over --experimental-permission (Rafael Gonzaga) [#56239](https://github.com/nodejs/node/pull/56239)
* \[[`ac222e1474`](https://github.com/nodejs/node/commit/ac222e1474)] - **test**: remove exludes for sea tests on PPC (Michael Dawson) [#56217](https://github.com/nodejs/node/pull/56217)
* \[[`c2fb3a70b5`](https://github.com/nodejs/node/commit/c2fb3a70b5)] - **test**: fix test-abortsignal-drop-settled-signals flakiness (Edigleysson Silva (Edy)) [#56197](https://github.com/nodejs/node/pull/56197)
...
* \[[`cd71d1838e`](https://github.com/nodejs/node/commit/cd71d1838e)] - **test\_runner**: exclude test files from coverage by default (Pietro Marchini) [#56060](https://github.com/nodejs/node/pull/56060)
* \[[`88c4137890`](https://github.com/nodejs/node/commit/88c4137890)] - **tools**: fix `node:` enforcement for docs (Antoine du Hamel) [#56284](https://github.com/nodejs/node/pull/56284)
* \[[`3392f33c00`](https://github.com/nodejs/node/commit/3392f33c00)] - **tools**: update github\_reporter to 1.7.2 (Node.js GitHub Bot) [#56205](https://github.com/nodejs/node/pull/56205)
* \[[`32ff44b914`](https://github.com/nodejs/node/commit/32ff44b914)] - **tools**: add REPLACEME check to workflow (Mert Can Altin) [#56251](https://github.com/nodejs/node/pull/56251)
* \[[`15e5c3ad5f`](https://github.com/nodejs/node/commit/15e5c3ad5f)] - **tools**: use `github.actor` instead of bot username for release proposals (Antoine du Hamel) [#56232](https://github.com/nodejs/node/pull/56232)
* \[[`af02a5547d`](https://github.com/nodejs/node/commit/af02a5547d)] - _**Revert**_ "**tools**: disable automated libuv updates" (Luigi Pinca) [#56223](https://github.com/nodejs/node/pull/56223)
* \[[`28cada6564`](https://github.com/nodejs/node/commit/28cada6564)] - **tools**: update gyp-next to 0.19.1 (Anna Henningsen) [#56111](https://github.com/nodejs/node/pull/56111)
* \[[`ee95b3a0fe`](https://github.com/nodejs/node/commit/ee95b3a0fe)] - **tools**: fix release proposal linter to support more than 1 folk preparing (Antoine du Hamel) [#56203](https://github.com/nodejs/node/pull/56203)
...
* \[[`4280bd0dcb`](https://github.com/nodejs/node/commit/4280bd0dcb)] - **util**: harden more built-in classes against prototype pollution (Antoine du Hamel) [#56225](https://github.com/nodejs/node/pull/56225)
* \[[`76915efdf7`](https://github.com/nodejs/node/commit/76915efdf7)] - **util**: fix Latin1 decoding to return string output (Mert Can Altin) [#56222](https://github.com/nodejs/node/pull/56222)
